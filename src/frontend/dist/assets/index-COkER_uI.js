...
function computeRoute(from, to) {
  ...
  const isCoastal = from.coords[1] > 78 || to.coords[1] > 78 || from.coords[1] < 73 || to.coords[1] < 73;
  if (isNorth && isCoastal) {
    chosenSegs = [ROAD_SEGMENTS[1], ROAD_SEGMENTS[4]];
    safetyScore = 75;
    warning = "Avoid NH-48 — severe flooding reported. Use Ring Road via bypass.";
  } else if (isSouth) {
...
function LocationSearchInput({
  ...
  const fetchSuggestions = reactExports.useCallback(async (query) => {
    if (query.length < 3) {
      setSuggestions([]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "absolute left-2.5 w-3.5 h-3.5 text-muted-foreground pointer-events-none" }),
        isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "absolute right-2.5 w-3.5 h-3.5 text-muted-foreground animate-spin" }),
      ...
      showDropdown && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: noResults ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-2.5 text-xs text-muted-foreground flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-3.5 h-3.5" }),
            "No locations found in India"
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: suggestions.map((r2, i) => {
            const parts = r2.display_name.split(",");
            const main = parts.slice(0, 2).join(",").trim();
            const sub = parts.slice(2, 4).join(",").trim();
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
                onMouseDown: () => handleSelect(r2),
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-foreground truncate", children: main }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: info.emoji }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold", children: info.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-white/70", children: "Current Weather" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-auto text-lg font-black", children: [
            weather.temp,
            "°C"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 text-[10px] text-white/80", children: [
        ...
        isRainy && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex items-center gap-1.5 bg-red-700/60 rounded-md px-2 py-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-3 h-3 text-yellow-300" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-yellow-200 font-semibold", children: "Flood risk elevated — rain detected" })
        ] })
      ]
    }
  );
...
function App() {
  ...
  const polylineLayerRef = reactExports.useRef(null);
  const routeLayerRef = reactExports.useRef(null);
  const markerLayerRef = reactExports.useRef(null);
  const [fromText, setFromText] = reactExports.useState("");
  const [toText, setToText] = reactExports.useState("");
  const [fromLoc, setFromLoc] = reactExports.useState(null);
  const [toLoc, setToLoc] = reactExports.useState(null);
  const [route, setRoute] = reactExports.useState(null);
  const [isCalculating, setIsCalculating] = reactExports.useState(false);
  const [lastUpdate] = reactExports.useState("Live — Updated 2 min ago");
  ...
  reactExports.useEffect(() => {
    ...
    fetch(
      ...
      const humidity = ((_b2 = (_a2 = data.hourly) == null ? void 0 : _a2.relativehumidity_2m) == null ? void 0 : _b2[0]) ?? 70;
      setWeatherData({
    ...
    navigator.geolocation.getCurrentPosition(
      async (pos) => {
        ...
        try {
          ...
          const data = await res.json();
          const name = data.display_name ? data.display_name.split(",").slice(0, 2).join(",").trim() : `${lat.toFixed(4)}, ${lon.toFixed(4)}`;
          const loc = { name, coords: [lat, lon] };
          setFromLoc(loc);
          setFromText(name);
          if (mapRef.current) {
  ...
  reactExports.useEffect(() => {
    ...
    for (const zone of HIGH_RISK_ZONES) {
      L.marker(zone.coords, { icon: warningIcon }).bindPopup(`<strong>⚠ High Flood Risk</strong><br/>${zone.label}`).addTo(map);
    }
  ...
  function handleFindRoute() {
    ...
    setTimeout(() => {
      ...
      if (routeLayerRef.current) {
        ...
        for (const seg of computed.segments) {
          L.polyline(seg.coords, {
            ...
            weight: 9,
            opacity: 1,
            dashArray: seg.level === "high" ? "8 6" : void 0
      ...
      if (markerLayerRef.current) {
        ...
        L.marker(fromLoc.coords, { icon: fromIcon }).bindPopup(`<strong>From:</strong> ${fromLoc.name}`).addTo(markerLayerRef.current);
        L.marker(toLoc.coords, { icon: toIcon }).bindPopup(`<strong>To:</strong> ${toLoc.name}`).addTo(markerLayerRef.current);
      }
      if (mapRef.current) {
  ...
  const safetyColor = route && route.safetyScore >= 85 ? "text-green-600" : route && route.safetyScore >= 65 ? "text-yellow-600" : "text-red-700";
  const canSearch = !!fromLoc && !!toLoc && !isCalculating;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-brand-teal text-white shadow-lg z-50 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-3 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white/20 rounded-lg p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Droplets, { className: "w-6 h-6" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold tracking-tight", children: "FloodSafe Navigator" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/70", children: "Real-time flood-aware routing — India" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs bg-white/10 rounded-full px-3 py-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-green-400 animate-pulse" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: lastUpdate })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-white/20 text-white hover:bg-white/30 text-xs", children: "🇮🇳 India" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { height: "580px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: mapContainerRef, className: "w-full h-full" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    CardHeader,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { className: "w-4 h-4 text-white" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-white text-sm font-bold tracking-wider uppercase", children: "Plan Your Route" })
                      ] })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 space-y-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      LocationSearchInput,
                      {
                        ...
                        extraAction: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "button",
                          {
                            type: "button",
                            ...
                            children: [
                              isGeolocating ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-3 h-3 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-3 h-3" }),
                              "Use My Location"
                            ]
                          }
                        )
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Button,
                      {
                        ...
                        style: {
                          background: canSearch ? "#2EAD4A" : void 0,
                          color: canSearch ? "white" : void 0
                        },
                        disabled: !canSearch,
                        onClick: handleFindRoute,
                        "data-ocid": "route_planner.primary_button",
                        children: isCalculating ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 border-2 border-white/50 border-t-white rounded-full animate-spin" }),
                          "Calculating..."
                    ...
                    !fromLoc && fromText.length > 0 && fromText.length < 3 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground text-center", children: "Type at least 3 characters to search" }),
                    route && !isCalculating && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-50 border border-green-200 rounded-xl p-3 text-center", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-1.5 mb-0.5", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-4 h-4 text-green-700" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-2xl font-black text-green-700", children: [
                                route.timeMin,
                                " mins away"
                              ] })
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-green-600 font-medium", children: "Estimated travel time" })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted rounded-lg p-2 text-center", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(Ruler, { className: "w-3.5 h-3.5 mx-auto mb-0.5 text-primary" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm font-bold", children: [
                                route.distanceKm,
                                " km"
                              ] }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground", children: "Distance" })
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted rounded-lg p-2 text-center", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-3.5 h-3.5 mx-auto mb-0.5 text-primary" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `text-sm font-bold ${safetyColor}`, children: [
                                route.safetyScore,
                                "%"
                              ] }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground", children: "Safety Score" })
                            ] })
                          ] }),
                          route.warning && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 bg-yellow-50 border border-yellow-200 rounded-lg p-2", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-3.5 h-3.5 text-yellow-600 mt-0.5 shrink-0" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-yellow-800 leading-tight", children: route.warning })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] text-muted-foreground", children: [
                            "Route via: ",
                            route.segments.map((s) => s.name).join(" → ")
                          ] })
                        ]
                      }
                    )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "shadow-xl border-0 py-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-3 space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground mb-2", children: "Flood Status" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium", children: "High Flood Risk" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium", children: "Moderate Risk" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium", children: "Safe Route" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 pt-1 border-t border-border", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-destructive", children: "Warning Zone" })
              ] })
            ] }) })
          }
        ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold", children: "Active Flood Alert — India" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-white/80", children: "Multiple states: avoid low-lying coastal and riverside roads" })
                    ] })
                  ]
                }
              ),
              weatherData && /* @__PURE__ */ jsxRuntimeExports.jsx(WeatherCard, { weather: weatherData })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white border-t border-border py-10 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold", style: { color: "#1F6F7E" }, children: "How FloodSafe Navigator Works" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-1 text-sm max-w-xl mx-auto", children: "Real-time flood data from IoT cloud sensors powers color-coded routing, helping you navigate safely through flood events across India." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            FeatureCard,
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "w-6 h-6" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            FeatureCard,
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Map$1, { className: "w-6 h-6" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 bg-muted rounded-2xl p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold uppercase tracking-wider text-muted-foreground mb-5", children: "Sensor Data Flow — Execution Process" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-4", children: FLOW_STEPS.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center w-28", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground mt-0.5", children: step.desc })
            ] }),
            i < FLOW_STEPS.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-4 h-4 text-muted-foreground shrink-0 hidden sm:block" })
          ] }, step.label)) })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-8 px-4", style: { background: "#1F6F7E" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 text-white text-center", children: STATS.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-bold", children: stat.value }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-white/70 mt-0.5", children: stat.label })
      ] }, stat.label)) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "footer",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-3 h-3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "FloodSafe Navigator — Sensor-powered flood routing across India" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:block opacity-40", children: "·" }),
...
function FeatureCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-white border border-border rounded-2xl p-5 shadow-sm hover:shadow-card transition-shadow", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 right-4 text-4xl font-black text-muted/40 select-none", children: step }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-sm mb-1", children: title }),
